...
void trieInsert(Trie* obj, char * word) 
{
    ...
    while(*word)
    {
        ...
        if(current->children[idx] == NULL) current->children[idx] = trieCreate();
...
bool trieSearch(Trie* obj, char * word)
{
    ...
    while(*word)
    {
        ...
        /* Letter not present; word not present in trie */
    ...
    /* Check if current has marked a end of a word*/
...
bool trieStartsWith(Trie* obj, char * prefix)
{
    ...
    while(*prefix)
    {
        ...
        /* Letter not present; can not be prefix*/
        if(current->children[idx] == NULL) return false;
